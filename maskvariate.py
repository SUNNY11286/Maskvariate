# -*- coding: utf-8 -*-
"""IITBombay_my_unet3dseg_final.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1IxDyvt2RHLt0uEidaPTXeiGVzAmR1iQ5
"""
...
def multivariate_cov(x,y): # y is serv, and x is z_prev ans z_present
  ...
  npcov = np.array(cov_mat)[0][0]#[0]
  npcovS = np.array([[np.dot(npcov,npcov.T)]])
...
def multivariate_norm(x,y): # x is z_present and z_prev and the mean & cov w.r.t. serv and each.
  ...
  norm = multivariate_normal.pdf(x, mean=multivariate_mean(x,y), cov=multivariate_cov(x,y))
...
# def contrastive_loss(z_prev,z_present,z_serv,margin = 0.2, lr=1e-3):
#   # print('///////////////////////////////////////')
#   #z_prev = multivariate_norm(z_prev)
#   #z_present = multivariate_norm(z_present)
#   z_prev = tf.math.l2_normalize(z_prev)
#   # print('z_prev:',z_prev)
#   z_present = tf.math.l2_normalize(z_present)
#   # print('z_present:',z_present)
...
#   loss = loss - (loss*lr)
#   # print('loss-loss*lr:',loss)
#   tmlr = triplate_mean_lr(z_prev,z_present,z_serv,lr)
#   # print('tmlr:',tmlr)
#   loss = tmlr/loss # new added
#   # print('tmlr/loss:',loss)
#   srv = tf.sqrt(tf.reduce_sum(tf.square(z_serv)))
#   # print('serv:',srv)
#   #srv = tf.math.l2_normalize(srv)
#   srv = tf.math.log(srv)
#   # print('log serv:',srv)
#   # print('loss final:',loss/srv)
#   # print('///////////////////////////////////////')
#   return loss/srv, tmlr
